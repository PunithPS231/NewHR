  ...
  <div class="login-box">
    ...
    <form action="signup" method="post">
      ...
      <div class="form-row">
        ...
        <input type="date" class="form-control" id="doj" name="doj" required placeholder="Date of Joining">
       </div>
  	  </div>
      ...
      <div class="form-group">
        <button type="submit" class="btn btn-login btn-block bg-info text-light"><b>Add account</b></button>
      </div> 
      <div class="form-group">
        <a href="login.html" class="btn btn-login btn-block bg-danger text-light"><b>Back</b></a>
      </div> 
    </form>
  </div>
</div>
